...
@dso_cache = dso_local local_unnamed_addr global [568 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 312154692, ; hash 0x129b1a44, from name: aot-WorkoutApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2391467739, ; hash 0x8e8ae6db, from name: WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 303
	...
	%struct.DSOCacheEntry {
		i64 2991304280, ; hash 0xb24bae58, from name: libaot-WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 3211530907, ; hash 0xbf6c129b, from name: aot-WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
	...
	%struct.DSOCacheEntry {
		i64 3570996658, ; hash 0xd4d915b2, from name: libaot-WorkoutApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
	...
	%struct.DSOCacheEntry {
		i64 3687945346, ; hash 0xdbd19482, from name: WorkoutApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 488
