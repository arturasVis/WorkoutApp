...
@dso_cache = dso_local local_unnamed_addr global [568 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3394392357809895085, ; hash 0x2f1b4ddd7b8f36ad, from name: libaot-WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8326507592266562171, ; hash 0x738db28a18a43a7b, from name: aot-WorkoutApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 240
	...
	%struct.DSOCacheEntry {
		i64 11662455820031823273, ; hash 0xa1d95dc729af0da9, from name: WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 364
	...
	%struct.DSOCacheEntry {
		i64 14153685342376321737, ; hash 0xc46bfdd456fe62c9, from name: aot-WorkoutApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
	...
	%struct.DSOCacheEntry {
		i64 15383002254620162779, ; hash 0xd57b670c45aafadb, from name: libaot-WorkoutApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
	...
	%struct.DSOCacheEntry {
		i64 17764679068181611576, ; hash 0xf688d17dbfc84438, from name: WorkoutApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WorkoutApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 541
...
@.env.3 = private unnamed_addr constant [37 x i8] c"92cd00d2-c25b-441a-8b67-869dc78c3d95\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.workoutapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-WorkoutApp.dll.so\00", align 16
